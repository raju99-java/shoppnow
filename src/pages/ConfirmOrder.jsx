...
const load = async () => {
    return await loadStripe('pk_test_51J44JvSGHGeEnAkP3XTh37UUn4eimMV5BnDcQxN6yuPS0WqBMW5Oa2N0mzTM9u3N4GpTPqIzPjsi1ibX9vRMnd3c00EGO8JDkh')
}
...
const ConfirmOrder = () => {
    ...
    const update_payment = async () => {
        ...
        if (orderId) {
            try {
                await axios.get(`https://shoppnow-api.vercel.app/api/order/confirm/${orderId}`)
