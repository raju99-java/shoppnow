...
const Shipping = () => {
    ...
    return (
        <div>
            <Headers />
            <section className='bg-[url("https://test-shoppnow.vercel.app/images/banner/order.jpg")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
                <div className='absolute left-0 top-0 w-full h-full bg-[#2422228a]'>
                    <div className='w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto'>
                        <div className='flex flex-col justify-center gap-1 items-center h-full w-full text-white'>
                            <h2 className='text-3xl font-bold'>Shopp.now</h2>
                                ...
                                <div className="bg-white p-6 shadow-sm rounded-md">
                                    ...
                                    }
                                    {
                                        res && <div className='flex flex-col gap-1'>
                                            ...
                                            <p className='text-slate-600 text-sm'>Email to info@shopp.now</p>
                                        </div>
                                    }
                                </div>
                                {
                                            ...
                                            p.products.map((pt, j) => <div key={i + 99} className='w-full flex flex-wrap'>
                                                <div className='flex sm:w-full gap-2 w-7/12'>
                                                    <div className='flex gap-2 justify-start items-center'>
                                                        <image className='w-[80px] h-[80px]' src={pt.productInfo.images[0]} alt="product image" />
